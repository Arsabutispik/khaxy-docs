...
## Member Role
The member role to be assigned after using the [`/register`](/commands/register) command.
...
## Male Role
The male role to be assigned after using the [`/register`](/commands/register) command and choosing the male as gender.

## Female Role
The female role to be assigned after using the [`/register`](/commands/register) command and choosing the female as gender.